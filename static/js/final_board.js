    ...
    <div class="modal_foot">
        <div class="destination">
            <div class="pint_mock_icon_container">
                <img src="{% static 'icons/upper-right-arrow.png' %}" alt="destination" class="pint_mock_icon">
            </div>
            <span>${pin_details.destination}</span>
        </div>

        <div class="pint_mock_icon_container">
            <img src="{% static 'icons/send.png' %}" alt="send" class="pint_mock_icon">
        </div>

        <div class="pint_mock_icon_container">
            <img src="{% static 'icons/ellipse.png' %}" alt="edit" class="pint_mock_icon">
        </div>
    </div>
</div>
